...
?> Demand paging 與 Demand segmentation 才會使用到虛擬記憶體。
...
$Q:$ Which of the following items of information would *not* be contained in an operating system's *process table*?
